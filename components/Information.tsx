  ...
  return (
    <div className="leading-loose">
      ...
      <p className="mt-4 text-neutral-800 dark:text-neutral-300">
        Building projects and experimenting with new tools and libraries in the
        open.
      </p>
    </div>
  );
